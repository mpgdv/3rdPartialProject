...
#include "GameOver2Scene.h" //Change to 2
...
{
    return LevelTwo::create(); //Physics
...
bool LevelTwo::init()
{
   ...
   // this->getPhysicsWorld()->setDebugDrawMask(PhysicsWorld::DEBUGDRAW_ALL);
    ...
    listener->onKeyPressed = CC_CALLBACK_2(LevelTwo::onKeyPressed, this);
    ...
    _spriteFondo_1 = Sprite::create("Backgrounds/Background_Autumn.png");
    _spriteFondo_2 = Sprite::create("Backgrounds/Background_Autumn.png");
    ...
    {
        problemLoading("'Background_Autumn.png'"); //HelloWorld.png
    }
    else
    {
    ...
    auto sprite_action_1 = RepeatForever::create(MoveBy::create(3.0, Vec2(-visibleSize.width / 2, 0)));
    _spriteFondo_1->runAction(sprite_action_1);
    auto sprite_action_2 = RepeatForever::create(MoveBy::create(3.0, Vec2(-visibleSize.width / 2, 0)));
    ...
    schedule(CC_SCHEDULE_SELECTOR(LevelTwo::addObstacles), 5.0f);
    schedule(CC_SCHEDULE_SELECTOR(LevelTwo::PointScore), 0.7f);
    ...
    auto myLabel = Label::createWithTTF("A U T U M N", "fonts/Marker Felt.ttf", 20);
...
void LevelTwo::PointScore(float delta)
{
    score++;
    _scoreLabel->setString(std::to_string(score));
}
...
void LevelTwo::onKeyPressed(cocos2d::EventKeyboard::KeyCode key, cocos2d::Event* event)
{
...
bool LevelTwo::onContactBegin(cocos2d::PhysicsContact& contact)
{
    ...
    if ((1 == a->getCollisionBitmask() && 2 == b->getCollisionBitmask()) || (2 == a->getCollisionBitmask() && 1 == b->getCollisionBitmask()))
    {
        ...
        auto scene = GameOver2::createScene(score);
...
void LevelTwo::addObstacles(float delta)
{
    auto visibleSize = Director::getInstance()->getVisibleSize();
    char obstacles[5][22]
        = { "Obstacles/banana.png", "Obstacles/garbage.png", "Obstacles/sewer.png","Obstacles/pumpkin.png","Obstacles/leaves.png"};

    Sprite* obstacle = nullptr;
    obstacle = Sprite::create(obstacles[random(0, 4)]);
    ...
    auto action = Sequence::create(
        MoveBy::create(3.0, Vec2(-visibleSize.width - 10, 0)),
        CallFuncN::create(CC_CALLBACK_1(LevelTwo::doRemoveFromParentAndCleanup, this, true)),
        NULL);
...
void LevelTwo::doRemoveFromParentAndCleanup(Node* sender, bool cleanup)
{
    sender->removeFromParentAndCleanup(cleanup);
}

void LevelTwo::initPhysics(cocos2d::Sprite* sprite)
{
...
void LevelTwo::initPhysicsChild(cocos2d::Sprite* sprite)
{
...
void LevelTwo::initPhysicsBorder(cocos2d::Sprite* sprite)
{
